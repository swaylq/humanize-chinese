...
skill 一侧每格跑三次、展示中位数那次，三次分数都标在旁边。
...
**用了 skill，四段跑完** 🟡 37分（三次：8/37/79，展示中位）：

> 打完两针疫苗，抗体不是待在身体里一动不动的。它会掉。新冠疫苗接种六个月后，血液里的中和抗体常常只剩下峰值的十分之一到五分之一，这个下降从第二个月就开始了。加强针要做的事，就是在抗体掉到不够用之前，再喊一次。
>
> 加强针不只是把抗体的数量补回原来的高度，它还改变了抗体的质量。第一次接种之后，免疫系统里那些记住了病毒长相的B细胞会在淋巴结里继续"进修"好几个月，反复筛选，留下结合力更强的版本。所以第三针打完，抗体水平往往超过前两针的峰值，而且对变异株的覆盖比原来宽。这不是简单的续杯。
>
